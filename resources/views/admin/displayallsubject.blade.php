                            ...
                            <div class="container mt-40">
                                ...
                                <div class="row mt-30">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="box16">
                                        <img src="{{asset('/public/'.$key['image'])}}" style="height: 300px; width: 400px;" class="mt-5">

                                            <div class="box-content">
                                                <span class="post" style="font-size: larger;">{{$key['subject_name']}}</span>
                                                <ul class="social">
                                                    <li><span><a href="{{route('admin.subjectdetail',$key['id'])}}">Go</a><span></li>
