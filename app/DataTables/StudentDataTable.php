    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($user) {
                ...
                $result .= "<a dataid=' $user->id ' class='rounded add btn btn-primary col-4 mr-2 ' style='height:40px; width: 120px;' href='".route('admin.questions',$user->id)."'>Add Question</a>";
                ...
                $result .= "<a dataid='$user->id' class='rounded display btn btn-success mr-2' href='".route('admin.alltest', $user->id)."' style='height:40px;'>v</a>";
