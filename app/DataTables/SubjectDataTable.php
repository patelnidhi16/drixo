    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($user) {
                ...
                $result .= "<a dataid='$user->slug' class='add_question rounded add btn btn-primary col-4 mr-2 ' style='height:40px; width: 180px; background-color:#5369f8; color:white;'>Add Question</a>";
                ...
                $result .= "<a dataid='$user->slug' class='rounded display btn btn-success mr-2' href='".route('admin.alltest', $user->slug)."' style='height:40px;'>View Test</a>";
