    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($user) {
                ...
                $result .= "<a dataid=' $user->id ' class='add_question rounded add btn btn-primary col-4 mr-2 ' style='height:40px; width: 180px; background-color:#5369f8; color:white;'>Add Question</a>";
